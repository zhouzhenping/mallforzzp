package com.zzp.mall.demo.config;

import com.zzp.mall.demo.bo.AdminUserDetails;
...
//            .antMatchers("/brand/list").authenticated() // 该路径需要登陆验证
//            .antMatchers("/brand/list").hasAnyAuthority("TEST") // 该路径需要TEST权限
